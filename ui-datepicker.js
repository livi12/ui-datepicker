    ...
    WdatePicker=(function() {
        ...
        A = $.$dpPath || J();
        if ($.$wdate) K(A + "skin/default/datepicker.css");
        V = Y;
        if ($.$crossFrame) {
            try {
        ...
        function I(G, _) {
            ...
            function E(K, J) {
                ...
                try {
                	...
                	// 如果 domain 和 hostname 不匹配，抛出异常设置新 domain
                	if(document.domain !== location.hostname) {
                		throw new Error('mismatch domain');
                	}
                } catch (E) {
                    F = true;
         ...
         */
        // function J() {
        //     return module.uri.substring(0, module.uri.lastIndexOf('/') + 1);
        // }
